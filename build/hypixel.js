...
import { cleanSkyBlockAuctionsResponse } from './cleaners/skyblock/auctions.js';
 ...
 */
export async function fetchAllAuctionsUncached() {
 ...
 * this is expensive and takes about a few seconds, use cached.fetchAllAuctions instead
 */
export async function fetchAllEndedAuctionsUncached() {
    return await sendCleanApiRequest({
        path: 'skyblock/auctions_ended',
        args: {}
    });
}
export async function getItemLowestBin(item) {
